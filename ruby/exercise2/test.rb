...
class TestArrayMethods < Test::Unit::TestCase
  def test_element_at
    ...
    assert_equal(nil, element_at([], 0))
    assert_equal(nil, element_at([1, 2, 3], -1))
  end
  ...
  def test_inclusive_range
    ...
    assert_equal([], inclusive_range([1, 2, 3], 1, 0))
    assert_equal([], inclusive_range([], 0, 0))
    assert_equal(nil, inclusive_range([1, 2, 3], -1, 2))
    assert_equal(nil, inclusive_range([1, 2, 3], 0, 5))
  end
  ...
  def test_non_inclusive_range
    ...
    assert_equal([], non_inclusive_range([1, 2, 3], 1, 0))
    assert_equal([], non_inclusive_range([], 0, 0))
    assert_equal(nil, non_inclusive_range([1, 2, 3], -1, 2))
    assert_equal(nil, non_inclusive_range([1, 2, 3], 0, 5))
  end
  ...
  def test_start_and_length
    ...
    assert_equal([], start_and_length([1, 2, 3], 1, 0))
    assert_equal([], start_and_length([], 0, 0))
    assert_equal(nil, start_and_length([1, 2, 3], -1, 2))
    assert_equal(nil, start_and_length([1, 2, 3], 0, 5))
  end
end